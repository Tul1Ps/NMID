...
public class PassengerCar {
    ...
    public PassengerCar(int number, String name, int cost, int maxCapacity) {
        this.No = number;
        this.name = name;
        this.cost = cost;
        MaxCapacity = maxCapacity;
        System.out.println("车辆序号：" + number + " 名称：" + name + " 费用：" + cost + " 最大载人：" + maxCapacity);
    }
    ...
    /*
        返回此种类车总共的最大载人数
     */
    public int getMaxCapacity() { return MaxCapacity * num; }

    /*
        返回租借的此种类车的总费用
     */
    public int value() { return cost * num * day; }
